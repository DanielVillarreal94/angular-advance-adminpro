...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'hospitales', component: UsuariosComponent, data: { titleParameter: 'Hospitales de la aplicación' }},
      { path: 'medicos', component: UsuariosComponent, data: { titleParameter: 'Médicos de la aplicación' }},
